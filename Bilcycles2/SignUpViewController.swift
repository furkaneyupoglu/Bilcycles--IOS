    ...
    @objc func handleSignUp() {
        ...
        Auth.auth().createUser(withEmail: email, password: pass) { user, error in
            if error == nil && user != nil {
                ...
                ref.child("user").child(userid).setValue(["nameoncard":"---","cardnumber":"---","money":"0","uid":userid])
                ...
                changeRequest?.commitChanges { error in
                    if error == nil {
                        ...
                        let errorAlert = UIAlertController(title: "Sign Up Error!", message: "Password must be 6 characters or more!", preferredStyle: UIAlertController.Style.alert)
